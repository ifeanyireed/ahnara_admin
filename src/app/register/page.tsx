...
export default function RegisterPage() {
  ...
  const handleQuickRegister = (role: "ADMIN" | "SUPER") => {
    setIsLoading(true);
    setError(null);
    setTimeout(() => {
      setIsLoading(false);
      ...
      login("mock-token-quick-reg", {
        id: `mock-${randomId}`,
        email: role === "SUPER" ? `super${randomId}@ahnara.com` : `admin${randomId}@ahnara.com`,
      ...
      >
        <AhnaraCard variant="flat" className="bg-white/80 backdrop-blur-md border border-slate-200/80 p-8 shadow-2xl rounded-3xl flex flex-col gap-6">
          ...
          <div className="flex flex-col items-center text-center gap-2">
            ...
            <p className="text-xs text-slate-400 font-semibold">Join Ahnara Health and begin your admin journey</p>
          </div>
          ...
          <div className="flex flex-col gap-2.5 pt-2 border-t border-slate-100">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <button
                type="button"
                onClick={() => handleQuickRegister("SUPER")}
